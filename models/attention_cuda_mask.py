...
class CUDAMaskAttention(nn.Module):
    def __init__(self, config, attn_cpp = None, attn_handle = None):
        super(CUDAMaskAttention, self).__init__()
        ...
        class AttnFunction(torch.autograd.Function):
            ...
            def forward(ctx, query, key, value, mask, layer_attn=None):
                ...
                attn_cpp.attn_forward(attn_handle, hQuery_p, hKey_p, hValue_p, hMask_p, hAttn_p, hOut_p)
